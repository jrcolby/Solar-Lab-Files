...
filenameAddress_cam1 = "C:\Users\OASIS_Deflectometry\Documents\GitHub\FringeProjection\Calibration_Mold\Camera1\";
filenameAddress_cam2 = "C:\Users\OASIS_Deflectometry\Documents\GitHub\FringeProjection\Calibration_Mold\Camera2\";
filenameName = "picture_%d.png";

%first loop is the number of pictures, second loop is the number of
%seconds between each picture
figure;gca;
previewhandle1= image( zeros([2448,3264, 3], 'uint8') );
preview(vid1,previewhandle1)
figure;gca;
previewhandle2 = image( zeros([2448,3264, 3], 'uint8') );
...
for j = 1:numImages
    ...
    if elapsedTime >= secs
        ...
        I_cam1 = rgb2gray(snapshot(vid1));
        I_cam2 = rgb2gray(snapshot(vid2));
