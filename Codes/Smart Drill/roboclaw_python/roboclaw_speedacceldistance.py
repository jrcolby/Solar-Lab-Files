...
while(1):
	rc.SpeedAccelDistanceM1(address,25000,250,2160,0);
#	rc.SpeedAccelDistanceM2(address,12000,-12000,42000,1);
#	rc.SpeedAccelDistanceM1(address,25000,2500,0,0);  #distance travelled is v*v/2a = 12000*12000/2*48000 = 1500
...
#	rc.SpeedAccelDistanceM2(address,48000,0,0,0);  #that makes the total move in one direction 48000
	...
	time.sleep(0);  #When no second command is given the motors will automatically slow down to 0 which takes 1 second